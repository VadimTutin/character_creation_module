...
def attack(char_name: str, char_class: str) -> str:
    """Определяет выбранного персонажа пользователем,
    В зависимости от выбора выводит соответствующий результат
    считая наносимый урон.
    """
...
def choice_char_class() -> str:
    """В зависимости от решения пользователя.
    устанавливает название персонажа
    и выводит информацию о нём.
    """
    approve_choice: str = ''
    char_class: str = ''
